...
const AmendmentModule = () => {
  const initialData: StudyVersion[] = useMemo(
    () => [
      {
        id: 1,
        study: "ST001",
...
export default AmendmentModule;