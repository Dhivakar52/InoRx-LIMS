    ...
    () => [
      {
        ...
        reviewComment: "Subject recovered well",
      },
...

      {
        ...
        finalAssessment: "Confirmed",
        reviewComment: "Monitor subject condition",
      },
...

      {
        ...
        medicalMonitorReview: "Reviewed",
        finalAssessment: "Follow-up Required",
        reviewComment: "Subject stabilized",
      },
    ...
    () => [
...

      {
        ...
        cell: ({ getValue }) => {
          ...
          return (
            <span
              className={`px-2 py-1 rounded text-xs font-medium ${value === "Severe"
...

      {
        ...
        cell: ({ getValue }) => {
          ...
          return (
            <span
              className={`px-2 py-1 rounded text-xs font-medium ${value === "Open"
